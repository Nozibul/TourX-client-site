...
const Banner = () => {
  ...
  return (
    <>
     <Container fluid>
      <Carousel style={{zIndex:"1"}} fade interval={6000} indicators={false} controls={false} pause="false">
        <Carousel.Item>
          <img
          ...
          <Carousel.Caption className="text-start">
            <Row className="align-items-center slide">
              <Col lg={6} md={12} sm={12}>
                    ...
                    <h1 className="sliderTitle">Amazing Tour <br /> In Indonesia</h1>
          ...
          <Carousel.Caption className="text-start">
            <Row className="align-items-center slide">
              <Col lg={6} md={12} sm={12}>
                    ...
                    <h1 className="sliderTitle">Amazing Tour <br /> In Spain</h1>
          ...
          <Carousel.Caption className="text-start">
            <Row className="align-items-center slide">
              <Col lg={6} md={12} sm={12}>
                    ...
                    <h1 className="sliderTitle">Amazing Tour <br /> In Australia</h1>
